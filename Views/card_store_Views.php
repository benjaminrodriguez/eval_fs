...
<link rel="apple-touch-icon" href="../Public/img/titre.png">
<link rel="apple-touch-icon" sizes="72x72" href="../Public/img/titre.png">
<link rel="apple-touch-icon" sizes="114x114" href="../Public/img/titre.png">
        ...
        <div class="color-bar-2 color-bg"></div>
            ...
            <div class="row header"><!-- Begin Header -->
                ...
                <div class="span4 logo">
                    <a href="index.php"><img src="Public/img/titre.png" alt="" /></a>
                    <br><br><br>
