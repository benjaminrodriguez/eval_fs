...
START TRANSACTION;
USE `eval_fin`;
INSERT INTO `eval_fin`.`events` (`id`, `title`, `date`, `date_debut`, `date_fin`, `description`, `patient_id`, `user_id`, `fiche_consultation_id`) VALUES (1, 'rdv medecin', '2019/02/02', '11:00', '12:00', 'ompo', 1, 1, 1);
INSERT INTO `eval_fin`.`events` (`id`, `title`, `date`, `date_debut`, `date_fin`, `description`, `patient_id`, `user_id`, `fiche_consultation_id`) VALUES (2, 'rdv acu', '2019/01/01', '17:00', '18:30', 'quotidien', 2, 2, 3);
INSERT INTO `eval_fin`.`events` (`id`, `title`, `date`, `date_debut`, `date_fin`, `description`, `patient_id`, `user_id`, `fiche_consultation_id`) VALUES (3, 'controle', '2019/10/12', '08:00', '08:30', 'orga', 1, 2, 2);
